...
// FlxAnimate you fucking suck at adding symbols i hate you so fucking much
...
class FlxAnim implements IFlxDestroyable
{
	...
	**/
	...
	public function addBySymbol(Name:String, SymbolName:String, FrameRate:Float = 0, Looped:Bool = true, X:Float = 0, Y:Float = 0)
	{
		...
		// 	}
		// }
		var symbolsArray:Array<String> = [for (name in symbolDictionary.keys()) name];
		if (symbolsArray.contains(SymbolName))
